...
import com.example.timur.mainmenu.activity.BaseActivity;
import com.example.timur.mainmenu.activity.MainActivity;
...
public class LoginActivityTest extends Activity {
    ...
    protected class AsyncLogin extends AsyncTask<String, JSONObject, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            //Check user validity
            if (result) {
                Intent i = new Intent(LoginActivityTest.this,
                        MainActivity.class);
